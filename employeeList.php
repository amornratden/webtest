        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="?page=employeeList">การจัดการข้อมูล</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
                    <li class="nav-item">
                        <a href="?page=employeeList">ข้อมูลพนักงาน</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-2">
                        <a href="" data-toggle="modal" data-target="#addDataEmp" class="btn btn-primary"><i class="fa fa-plus-square" aria-hidden="true"></i> เพิ่มบัญชีพนักงาน</a>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><i class="fa fa-list"></i> ข้อมูลพนักงานระบบทั้งหมด</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $i = 1;
                                        $Chkprefix = "";
                                        $select_dataEmp = $conn->query("SELECT * FROM tbl_employee WHERE emp_administrator = '0' AND NOT emp_id = '$emp_id' ORDER BY emp_id ASC");
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#editDataEmp<?= $row_dataEmp['emp_id'] ?>"><i class="icon-note" aria-hidden="true"></i> แก้ไขข้อมูล</a>
                                                        <a href="controller/form.php?delEm=<?= $row_dataEmp['emp_id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('คุณต้องการลบข้อมูลพนักงานใช่หรือไม่?');"><i class="icon-trash" aria-hidden="true">ลบข้อมูล</i></a> 
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="controller/form.php" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="d-flex justify-content-end">
                                                                        ...
                                                                        <button type="submit" name="btn_updateStatusEmp" class="btn btn-primary">บันทึกข้อมูล</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="editDataEmp<?= $row_dataEmp['emp_id'] ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-body">
                                                                <form action="controller/form.php" method="post" enctype="multipart/form-data">
                                                                    <h3><i class="fa fa-plus-square"></i> แบบฟอร์มแก้ไขพนักงาน</h3>
                                                                    <h6 class="text-muted">EDIT EMPLOYEE INFORMATION</h6>
                                                                    <hr>
                                                                    <div class="mb-2">
                                                                    ...
                                                                    <div class="mb-2">
                                                                        ...
                                                                        <input type="test" class="form-control" name="emp_user" id="exampleFormControlInput1" value="<?= $row_dataEmp['emp_user'] ?>" required>
                                                                    </div>
                                                                    <hr class="mt-3">
                                                                    <div class="d-flex justify-content-start">
                                                                        <button type="submit" name="btn_editDataEmp" class="btn btn-success px-5"><i class="fa fa-check-square-o" aria-hidden="true"> บันทึกข้อมูล</i></button>
...
<!-- Modal -->
<div class="modal fade" id="addDataEmp" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <form action="controller/form.php" method="post" enctype="multipart/form-data">
                    <h3><i class="fa fa-plus-square"></i> แบบฟอร์มเพิ่มบัญชีพนักงาน</h3>
                    <h6 class="text-muted">ADD EMPLOYEE ACCOUNT</h6>
                    <hr>
                    <div class="mb-2">
                        <label for="exampleFormControlInput1" class="form-label">ชื่อ-นามสกุล</label>
                    ...
                    <hr class="mt-3">
                    <div class="d-flex justify-content-start">
                        <button type="submit" name="btn_addDataEmp" class="btn btn-success px-5"><i class="fa fa-check-square-o" aria-hidden="true"> บันทึกข้อมูล</i></button>
                        <button type="button" class="btn btn-outline-danger mx-1" data-dismiss="modal">ปิดหน้าต่าง</button>
                    </div>
                </form>
            </div>
