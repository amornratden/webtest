    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">ข้อมูลรายการยกเลิกคำสั่งซื้อสินค้า</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="?page=ordersCancleList">การจัดการข้อมูลรายการยกเลิกคำสั่งซื้อสินค้า</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
                    <li class="nav-item">
                        <a href="?page=ordersCancleList">ข้อมูลรายการยกเลิกคำสั่งซื้อสินค้า</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        WHERE uorder_emp_id = emp.emp_id AND uorder.uorder_status = '5' 
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><span class="btn btn-sm btn-danger">คำสั่งซื้อถูกยกเลิก</span></td>
                                                    <td>
                                                        <a href="controller/form.php?updateStatusReCancleOrderId=<?= $uorder_id ?>" class="btn btn-sm btn-success" onclick="confirm('คุณต้องการคืนค่าคำสั่งซื้อเลขที่ <?= $uorder_id ?> ใช่หรือไม่?')"><i class="flaticon-multimedia-2" aria-hidden="true"> คืนค่าคำสั่งซื้อ</i></a>
                                                        <a href="controller/form.php?delUorderId=<?= $uorder_id ?>" class="btn btn-sm btn-danger" onclick="confirm('คุณต้องการลบคำสั่งซื้อเลขที่ <?= $uorder_id ?> ใช่หรือไม่?')"><i class="flaticon-interface-5" aria-hidden="true"> ลบรายการ</i></a>
                                                    </td>
                                                </tr>
